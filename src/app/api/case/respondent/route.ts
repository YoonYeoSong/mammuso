...
const schema = z.object({ token: z.string().min(30), statement: z.string().min(20).max(5000), answers: z.record(z.string().max(1500)).optional().default({}), privacyPolicyAgreed: z.literal(true), aiProcessingAgreed: z.literal(true) });
