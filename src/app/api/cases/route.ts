...
const inputSchema = z.object({ incidentDate: z.string().regex(/^\d{4}-\d{2}-\d{2}$/), statement: z.string().min(20).max(5000), privacyPolicyAgreed: z.literal(true), aiProcessingAgreed: z.literal(true), strongLanguageAgreed: z.literal(true) });
